...
<body>
    ...
    <div class="container">
        <div class="main-video">
            <div class="video">
                <video src="./python course/1.mp4" controls muted></video>
                <h3 class="title">01. What is & Why Python?</h3>
            </div>
        </div>
        <div class="video-list">
                <h4>Downloding program & <br>About Java Script</h4>
            <div class="vid active">
                <video src="./python course/1.mp4" muted></video>
                <h3 class="title">01. What is & Why Python?</h3>
            </div>
            <div class="vid">
                <video src="./python course/2.mp4" muted></video>
                <h3 class="title">02. About Python.</h3>
            </div>
            <div class="vid">
                <video src="./python course/4.mp4" muted></video>
                <h3 class="title">03. How downloding Python?</h3>
            </div>
            <div class="vid">
                <video src="./python course/3.mp4" muted></video>
                <h3 class="title">04. If you have a problem with dowmloding</h3>
            </div>
        </div>
    </div>
    <div class="but">
        <a href="chapter1.php"> <button>Go to <br> Chapter 1</button></a>
           </div>
           <footer>
            <div class="footer">
