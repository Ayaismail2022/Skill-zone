        ...
        <div class="content">
            ...
            <div class="W_learn">
                <dl>
                    ...
                    <dd>-Learning PHP can equip you with the skills to develop dynamic and interactive web
                        applications.</dd>
                </dl>
            </div>
            <br>
            ...
            <div class="but">
                ...
                <a href="./successApply.php?course_name=PHP"><button>Apply</button></a>
            </div>
        </div>
        <div class="photo">
            <div class="photo1">
                <img class="logo" src="../styles/imgs/php.png" alt="PHP logo">
                <h3 id="h3">PHP</h3>
            </div>
        </div>
    </div>
