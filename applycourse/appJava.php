        ...
        <div class="content">
            ...
            <div class="W_learn">
                <dl>
                    ...
                    <dd>-Learning Java can provide you with a strong foundation for building various applications and
                        software solutions.</dd>
                </dl>
            </div>
            <br>
            <div class="hours">
            ...
            <div class="but">
                ...
                <a href="./successApply.php?course_name=Java"><button>Apply</button></a>
            </div>
        </div>
        <div class="photo">
            <div class="photo1">
                <img class="logo" src="../styles/imgs/java.png" alt="Java logo">
                <h3 id="h3">Java</h3>
            </div>
        </div>
    </div>
    ...
    <div class="footer">
        <div class="footer-content">
            <div class="footer-section-about">
                <a href="../index.php" style="text-decoration: none;color: aliceblue; "><h1 style="font-family: 'Agentur';">Skill
                        Zone<span>| BETA</h1></a>
